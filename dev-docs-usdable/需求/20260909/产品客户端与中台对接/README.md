...
| 当前仓库做 | 中台做 |
| --- | --- |
| `productclient` remote/fake、gateway sender、签名验证、缓存、凭证安全保存、PEP、UI 状态与 Windows 验收 | 短信/账号、控制面、供应商路由、token 预留/结算、账本、KMS、服务端审计、sandbox 与运维 |
...
P0-00 upstream/profile 基线
  ...
  -> fake 并行开发 P0-02/03/04/06/08/09/10
  -> sandbox 联调
