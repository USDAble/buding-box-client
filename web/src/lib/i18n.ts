...
export const en: Record<string, string> = {
 ...
 "wallet.error.PAYMENT_MERCHANT_CONFIG_MISMATCH":"The original payment merchant configuration must be restored. Check the original order later.",
  "wallet.title": "Wallet and recharge",
  "wallet.recharge": "Recharge",
  "wallet.ledger": "Point ledger",
  "wallet.usage": "Usage",
  "wallet.pricing": "Model prices",
  "wallet.points": "points",
  "wallet.available_points": "Available points",
  "wallet.reserved_points": "Reserved points",
  "wallet.total_recharged_points": "Recharged points",
  "wallet.total_consumed_points": "Consumed points",
  "wallet.recharge_hint": "Choose a published amount and payment method. Amounts and points are confirmed by the server.",
  "wallet.no_options": "No recharge options have been published.",
  "wallet.payment_method": "Payment method",
  "wallet.choose": "Please select",
  "wallet.payment_unavailable": "Payment channels are not ready yet. Published options and order history remain available.",
  "wallet.create_order": "Create payment order",
  "wallet.resume_order": "Continue / retry this order",
  "wallet.order": "Order",
  "wallet.orders": "Recharge orders",
  "wallet.orders_range": "Recent 30 days. Reopening this page reloads your orders.",
  "wallet.review": "Payment is under review. Do not create duplicate orders.",
  "wallet.paid": "The server confirmed payment and crediting.",
  "wallet.scan": "Scan with WeChat to pay.",
  "wallet.open_payment": "Open payment page",
  "wallet.pending_url": "The payment address is unavailable or expired. Check this order; do not create a duplicate just because the page has not updated.",
  "wallet.expires": "Payment expires",
  "wallet.payment_truth": "Only a server-confirmed paid order counts as credited. Returning from a payment page does not confirm payment.",
  "wallet.check_payment": "Check payment status",
  "wallet.time": "Time",
  "wallet.amount": "Payment amount",
  "wallet.status": "Status",
  "wallet.details": "View / continue",
  "wallet.empty": "No records.",
  "wallet.more": "Load more",
  "wallet.ledger_hint": "Reserve and release change available credit; they are not additional charges.",
  "wallet.event": "Event",
  "wallet.available_change": "Available change",
  "wallet.reserved_change": "Reserved change",
  "wallet.reference": "Related order / run",
  "wallet.from": "From",
  "wallet.to": "To",
  "wallet.search": "Search",
  "wallet.usage_hint": "Date filters use Beijing calendar days, up to 90 days. Pending usage is not a final charge.",
  "wallet.total": "Net consumption in filter range",
  "wallet.pending": "Pending verification",
  "wallet.model": "Model",
  "wallet.input_tokens": "Input tokens",
  "wallet.output_tokens": "Output tokens",
  "wallet.net_points": "Net points",
  "wallet.pricing_hint": "Points per one million tokens. Effective published prices apply; the client does not calculate final charges.",
  "wallet.input": "Input",
  "wallet.output": "Output",
  "wallet.cache": "Cache read",
  "wallet.effective": "Effective time",
  "wallet.status.pending": "Pending payment",
  ...
  "wallet.event.correction": "Correction",
  "wallet.billing.reserved": "Reserved",
  "wallet.billing.pending_usage": "Pending usage",
  "wallet.billing.settled": "Settled",
  "wallet.billing.free": "Free",
  "wallet.billing.released": "Released",
  "wallet.billing.observe": "Historical observation",
  "wallet.error.generic": "Could not complete the request. Retry or check the original order.",
  "wallet.error.PAYMENT_UNAVAILABLE": "The payment channel is not configured or is unavailable. No simulated payment is used.",
  "wallet.error.PAYMENT_VERIFICATION_FAILED": "Payment is awaiting verification. Check this order again later.",
  "wallet.error.RECHARGE_DISABLED": "Recharge is currently disabled. Existing orders can still be checked.",
  "wallet.error.RECHARGE_OPTION_CHANGED": "The recharge option changed. Refresh the published options.",
  "wallet.error.IDEMPOTENCY_CONFLICT": "The order details changed. Restore the original selection or start a new request.",
  "wallet.error.WALLET_PROTECTED": "The wallet is under review. New charges and recharges are paused.",
  "wallet.error.NETWORK_UNAVAILABLE": "Network unavailable. Your order can be retried with the same request.",
  "wallet.error.UPSTREAM_UNAVAILABLE": "The service is temporarily unavailable. Retry later.",
  "wallet.error.INVALID_REQUEST": "Check the selected option, payment method and date range.",
  "wallet.error.CLIENT_DISABLED": "This account or device is disabled.",
  "wallet.error.RECHARGE_ORDER_NOT_FOUND": "Order unavailable for this account. Refresh your order history.",
  "model.pricing_not_configured": "Point pricing not configured",
  "model.unavailable": "Currently unavailable",
  "product.init.loading": "Loading workspace data…",
  "product.init.failed": "Could not load",
  "product.init.catalog": "Models",
  "product.init.credits": "Balance",
  "product.init.box": "Box information",
  "product.init.dictionary": "Server dictionary",
  "product.init.all": "Workspace data",
  "product.init.dictionary_fallback": "Using the last verified or built-in dictionary",
  ...
  "agents.gallery_detail": "View details",
  "agents.gallery_use": "Use expert",
  "agents.gallery_platform": "Platform published",
  "agents.gallery_local": "My experts",
  "agents.gallery_builtin": "Built-in experts",
  "agents.gallery_cached": "Showing cached directory",
  "agents.gallery_refreshing": "Updating directory…",
  "agents.gallery_refresh_failed": "Update failed; cached directory retained",
  "agents.gallery_retry": "Reload",
  ...
  "chat.reasoning_level_default": "Model default",
  "chat.reasoning_level_off": "Off",
  "chat.reasoning_level_minimal": "Minimal",
  "chat.reasoning_level_low": "Low",
  "chat.reasoning_level_medium": "Medium",
  "chat.reasoning_level_high": "High",
  "chat.reasoning_level_xhigh": "Extra high",
  "chat.reasoning_level_max": "Maximum",
  ...
  "settings.help.guides": "FAQs",
  "settings.help.full": "Open help center",
  ...
  "settings.help.feedback_count": "{count} / {limit} characters",
  "settings.help.feedback_title_placeholder": "Briefly describe your issue or suggestion",
  "settings.help.feedback_content_placeholder": "What happened? What would you like to improve? Please include the details that matter.",
  "settings.help.feedback_optional": "Additional details (optional)",
  "settings.help.feedback_reproduction_placeholder": "Describe the steps that led to the issue",
  "settings.help.feedback_expected_placeholder": "What did you expect to happen?",
  "settings.help.feedback_contact_placeholder": "Email or another way to reach you",
  "settings.help.feedback_required": "Title and feedback are required",
  "settings.help.feedback_submitting": "Sending…",
  ...
  "settings.help.website_soon": "Help center URL pending",
  ...
  "privacy.personal_info_desc": "Mask supported personal data in input text before sending; locks after the first message.",
  "privacy.private_session": "Private session",
  "privacy.private_session_desc": "Only models supporting private transmission; locks after the first message.",
  ...
  "settings.reasoning_per_model": "Choose supported reasoning options for each model in the message input. Show reasoning is a separate display setting.",
  ...
  "settings.workspace_dir_desc": "Default working directory for new web sessions: {path}",
  ...
  "product.switch_to_login": "Already activated? Sign in",
  ...
  "product.err_activation_required": "This phone number has not been registered and activated yet",
  ...
  // OCTO-FORK: current legal publication loading states.
  "product.legal_load_failed": "Unable to load this document. Please try again.",
  "product.legal_retry": "Retry",
  "product.err_mobile_already_activated": "This phone is already activated. Please use SMS login.",
  "product.err_client_disabled": "Access is disabled. Please contact your administrator.",
  "product.err_idempotency_conflict": "This attempt has already been processed. Please submit again.",
  ...
  "product.panel.logout": "Log out",
  "product.panel.logout_confirm": "You will need to verify your phone again to re-enter. Your sessions and settings will not be deleted.",
  "product.panel.logout_not_revoked": "Signed out on this device, but the platform session was not revoked. Reconnect, sign in, and sign out again.",
  "product.panel.upgrade": "Upgrade",
  "product.panel.upgrade_soon": "Upgrading will be available in a later version",
  "product.panel.balance": "Balance",
  "product.panel.recharge": "Top up",
  "product.panel.refresh": "Refresh",
  "product.panel.refresh_failed": "Could not read the balance. The number above is the last one we received.",
  "product.panel.recharge_soon": "Topping up will be available in a later version",
  "product.panel.license_permanent": "Activated · No expiry",
  "product.panel.license_active": "Active · {n} days left",
  "product.panel.license_active_today": "Active · expires today",
  ...
  "product.panel.license_phone": "Bound phone: {phone}",
...
export const zh: Record<string, string> = {
 ...
 "wallet.error.PAYMENT_MERCHANT_CONFIG_MISMATCH":"原支付商户配置待恢复，请稍后查询原订单。",
  "wallet.title": "钱包与充值",
  "wallet.recharge": "充值",
  "wallet.ledger": "积分流水",
  "wallet.usage": "用量明细",
  "wallet.pricing": "模型价格",
  "wallet.points": "积分",
  "wallet.available_points": "可用积分",
  "wallet.reserved_points": "冻结积分",
  "wallet.total_recharged_points": "累计充值积分",
  "wallet.total_consumed_points": "累计消耗积分",
  "wallet.recharge_hint": "请选择后台发布的充值档位与支付方式，金额和到账积分以服务端订单为准。",
  "wallet.no_options": "后台暂未发布可用充值档位。",
  "wallet.payment_method": "支付方式",
  "wallet.choose": "请选择",
  "wallet.payment_unavailable": "真实支付通道尚未配置完成或充值暂未开放。仍可查看后台档位及历史订单。",
  "wallet.create_order": "创建支付订单",
  "wallet.resume_order": "继续／重试本次订单",
  "wallet.order": "订单",
  "wallet.orders": "充值订单",
  "wallet.orders_range": "默认显示最近30天订单。关闭页面后重新打开可继续查询。",
  "wallet.review": "支付结果正在核查，请勿重复下单。",
  "wallet.paid": "服务端已确认支付及入账。",
  "wallet.scan": "使用微信扫码支付。",
  "wallet.open_payment": "打开支付页面",
  "wallet.pending_url": "支付地址尚未就绪或已到期。请查询原订单，不要因页面未更新重复下单。",
  "wallet.expires": "支付有效期至",
  "wallet.payment_truth": "仅服务端确认“已支付”才代表到账，支付页面返回不等于付款成功。",
  "wallet.check_payment": "查询支付结果",
  "wallet.time": "时间",
  "wallet.amount": "实付金额",
  "wallet.status": "状态",
  "wallet.details": "查看／继续",
  "wallet.empty": "暂无记录。",
  "wallet.more": "加载更多",
  "wallet.ledger_hint": "冻结与释放是额度变化，不是再次扣费。",
  "wallet.event": "类型",
  "wallet.available_change": "可用变动",
  "wallet.reserved_change": "冻结变动",
  "wallet.reference": "关联订单／运行",
  "wallet.from": "开始日期",
  "wallet.to": "结束日期",
  "wallet.search": "查询",
  "wallet.usage_hint": "日期按北京时间自然日查询，最长90天。待核实用量不表示已最终扣费。",
  "wallet.total": "筛选范围净消耗",
  "wallet.pending": "待核实",
  "wallet.model": "模型",
  "wallet.input_tokens": "输入Token",
  "wallet.output_tokens": "输出Token",
  "wallet.net_points": "净消耗积分",
  "wallet.pricing_hint": "每百万Token积分价格。计费以中台生效价格为准，客户端不自行计算最终费用。",
  "wallet.input": "输入",
  "wallet.output": "输出",
  "wallet.cache": "缓存读取",
  "wallet.effective": "生效时间",
  ...
  "wallet.event.correction": "纠错",
  "wallet.billing.reserved": "已冻结",
  "wallet.billing.pending_usage": "用量待核实",
  "wallet.billing.settled": "已结算",
  "wallet.billing.free": "免费",
  "wallet.billing.released": "已释放",
  "wallet.billing.observe": "历史观察记录",
  "wallet.error.generic": "请求未完成，请重试或查询原订单。",
  "wallet.error.PAYMENT_UNAVAILABLE": "支付通道尚未配置完成或暂不可用，不会使用模拟支付。",
  "wallet.error.PAYMENT_VERIFICATION_FAILED": "支付结果尚待验证，请稍后查询原订单。",
  "wallet.error.RECHARGE_DISABLED": "当前充值已暂停，仍可查询已有订单。",
  "wallet.error.RECHARGE_OPTION_CHANGED": "充值档位已变化，请刷新后台档位。",
  "wallet.error.IDEMPOTENCY_CONFLICT": "本次订单参数已变化，请恢复原选择或发起新请求。",
  "wallet.error.WALLET_PROTECTED": "钱包正在核查，暂不能新建消费或充值。",
  "wallet.error.NETWORK_UNAVAILABLE": "网络暂不可用，重试会沿用本次订单请求。",
  "wallet.error.UPSTREAM_UNAVAILABLE": "服务暂时不可用，请稍后重试。",
  "wallet.error.INVALID_REQUEST": "请检查充值档位、支付方式或日期范围。",
  "wallet.error.CLIENT_DISABLED": "当前账号或设备已停用。",
  "wallet.error.RECHARGE_ORDER_NOT_FOUND": "当前账号无法查看此订单，请刷新本人订单列表。",
  "model.pricing_not_configured": "暂未配置积分价格",
  "model.unavailable": "暂不可用",
  "product.init.loading": "正在加载工作台数据…",
  "product.init.failed": "暂未加载成功",
  "product.init.catalog": "模型目录",
  "product.init.credits": "积分余额",
  "product.init.box": "盒子信息",
  "product.init.dictionary": "服务端词库",
  "product.init.all": "工作台数据",
  "product.init.dictionary_fallback": "继续使用已验证缓存或内置词库",
  "nav.sessions": "会话",
  ...
  "agents.gallery_detail": "查看详情",
  "agents.gallery_use": "使用专家",
  "agents.gallery_platform": "中台发布",
  "agents.gallery_local": "我的专家",
  "agents.gallery_builtin": "内置专家",
  "agents.gallery_cached": "正在显示缓存目录",
  "agents.gallery_refreshing": "正在更新目录…",
  "agents.gallery_refresh_failed": "更新失败，保留缓存目录",
  "agents.gallery_retry": "重新加载",
  "chat.thinking": "思考中",
  "chat.thinking_0": "思考中",
  "chat.thinking_1": "沉思中",
  "chat.thinking_2": "处理中",
  ...
  "chat.reasoning": "推理强度:",
  "chat.reasoning_level_default": "模型默认",
  "chat.reasoning_level_off": "关闭推理",
  "chat.reasoning_level_minimal": "极低",
  "chat.reasoning_level_low": "低",
  "chat.reasoning_level_medium": "中",
  "chat.reasoning_level_high": "高",
  "chat.reasoning_level_xhigh": "极高",
  "chat.reasoning_level_max": "最高",
  ...
  "settings.help.guides": "常见问题",
  "settings.help.full": "前往帮助中心",
  ...
  "settings.help.feedback_count": "{count} / {limit} 字",
  "settings.help.feedback_title_placeholder": "用一句话概括遇到的问题或建议",
  "settings.help.feedback_content_placeholder": "遇到了什么问题？或者你希望改进什么？请描述具体情况，方便我们了解。",
  "settings.help.feedback_optional": "补充信息（选填）",
  "settings.help.feedback_reproduction_placeholder": "例如：打开哪个页面、进行了什么操作后出现问题",
  "settings.help.feedback_expected_placeholder": "你期望看到什么结果？",
  "settings.help.feedback_contact_placeholder": "邮箱或其他便于联系你的方式",
  "settings.help.feedback_required": "请填写标题和反馈内容",
  "settings.help.feedback_submitting": "正在提交…",
  ...
  "settings.help.website_soon": "帮助中心地址待配置",
  ...
  "privacy.personal_info_desc": "发送前脱敏输入文本中已支持的个人信息；首条消息后锁定。",
  "privacy.private_session": "私密会话",
  "privacy.private_session_desc": "仅使用支持私密传输的模型；首条消息后锁定。",
  ...
  "settings.reasoning_per_model": "请在模型输入框中为各模型选择其支持的推理选项。「显示推理」独立控制展示。",
  ...
  "settings.workspace_dir_desc": "新建 Web 会话的默认工作目录：{path}",
  ...
  "settings.experimental.computer_use_hint_windows": "无需系统授权，但以管理员身份运行的应用会忽略来自非管理员{brand}的输入。实验性功能，使用时请留意它的每一步操作。",
  "settings.update": "更新",
  ...
  "product.switch_to_login": "已经激活过？直接登录",
  ...
  "product.err_activation_required": "该手机号尚未注册和激活！",
  ...
  "product.legal_load_failed": "协议暂时无法加载，请重试。",
  "product.legal_retry": "重新加载",
  "product.err_mobile_already_activated": "该手机号已激活，请切换到短信登录。",
  "product.err_client_disabled": "授权已停用，请联系管理员。",
  "product.err_idempotency_conflict": "本次请求已处理，请重新提交。",
  ...
  "product.panel.credits": "积分",
  "product.panel.license": "授权",
  "product.panel.sensitive_library": "敏感词库",
  "product.panel.help": "帮助",
  "product.panel.box": "我的盒子",
  "product.panel.check_updates": "检查更新",
  "product.panel.about": "关于",
  "product.panel.soon": "即将支持",
  "product.panel.logout": "退出登录",
  "product.panel.logout_confirm": "退出后需重新验证手机号才能进入。会话和配置不会删除。",
  "product.panel.logout_not_revoked": "本机已退出登录，但平台会话未能撤销。请联网后重新登录并再次退出。",
  "product.panel.upgrade": "升级",
  "product.panel.upgrade_soon": "升级功能将在后续版本提供",
  "product.panel.balance": "余额",
  "product.panel.recharge": "充值",
  "product.panel.refresh": "刷新",
  "product.panel.refresh_failed": "读取余额失败。上面显示的是上一次取到的数字。",
  "product.panel.recharge_soon": "充值功能将在后续版本提供",
  "product.panel.license_permanent": "已激活 · 长期有效",
  "product.panel.license_active": "已激活 · 剩余 {n} 天",
  "product.panel.license_active_today": "已激活 · 今日到期",
  ...
  "product.panel.license_phone": "绑定手机号：{phone}",
  ...
  "product.panel.feedback_unavailable": "反馈通道暂未配置。",
